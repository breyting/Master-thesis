...
############### Transformation du CRS wallon pour correspondre au CRS flamand
...
############### Tentative de méthode de voronoi
...
plot(st_intersection(st_transform(flandre_voronoi_multipolygon, 31370), frontiere_Belgique_BD72, col = 0))
